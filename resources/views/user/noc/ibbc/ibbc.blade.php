...
@section('content')
        ...
        <form action="{{ route('application.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-8 mb-10">
                    <div class="grid gap-1">
                        ...
                        <input type="text" name="last_education" placeholder="Last Education" class="w-full h-11 px-3 border border-gray-400 rounded">
                    </div>
                    <div class="grid gap-1">
                        <label for="">Graduation Date</label>
                        <input type="date" name="graduation_date" class="w-full h-11 px-3 border border-gray-400 rounded">
                    </div>
                    <div class="grid gap-1">
                        <label for="">Next Education</label>
                        <input type="text" name="universitas_selanjutnya" placeholder="Next Education" class="w-full h-11 px-3 border border-gray-400 rounded">
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto mb-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-8">
                    ...
                    <div class="grid gap-1">
                        <div class="flex flex-col items-center gap-4 w-full">
                            <label class="text-center">Surat Acceptance Universitas Pakistan</label>

                            <!-- Wrapper Upload -->
                            <div id="upload-wrapper-acceptance" class="w-full max-w-sm flex justify-center gap-4">
                                <button type="button"
                                    id="upload-btn-acceptance"
                                    onclick="document.getElementById('surat_acceptance_universitas_pakistan').click()"
                                    class="bg-[#CB1428] text-white px-4 py-2 rounded hover:bg-[#a71120] transition">
                                    Upload
                                </button>
                                <input type="file" name="surat_acceptance_universitas_pakistan" id="surat_acceptance_universitas_pakistan" class="hidden">
                            </div>
                        </div>
                    </div>
                    <div class="grid gap-1">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            handleFileUpload('surat_acceptance_universitas_pakistan', 'upload-wrapper-acceptance');
