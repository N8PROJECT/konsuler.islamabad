    ...
    <template id="member-template">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-8 border-t pt-8">
            ...
            <div class="grid gap-1">
                ...
                <input type="date" name="members[0][visa_start_date]" class="w-full h-11 px-3 border border-gray-400 rounded">
            </div>
            <div class="grid gap-1">
            ...
            <div class="grid gap-1">
                ...
                <input type="date" name="members[0][visa_expired_date]" class="w-full h-11 px-3 border border-gray-400 rounded">
            </div>
        </div>
    </template>
